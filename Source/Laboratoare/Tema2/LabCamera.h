	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				glm::mat4 change = glm::rotate(glm::mat4(1.0f), angle, right);
				forward = glm::normalize(glm::vec3(change * glm::vec4(forward, 1)));
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				// Use glm::rotate()
				glm::mat4 change = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));
				forward = glm::normalize(glm::vec3(change * glm::vec4(forward, 1)));
				up = glm::normalize(glm::vec3(change * glm::vec4(up, 1)));
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				glm::mat4 change = glm::rotate(glm::mat4(1.0F), angle, forward);
				right = glm::normalize(glm::vec3(change * glm::vec4(right, 1)));
				up = glm::normalize(glm::cross(right, forward));
			}
